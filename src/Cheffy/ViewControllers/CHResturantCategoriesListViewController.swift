...
class CHResturantCategoriesListViewController: UIViewController {

    @IBOutlet weak var btnBack: UIButton!
    @IBOutlet weak var tblCategory: UITableView!
    @IBOutlet weak var lblResturantsCategories: UILabel!
...
extension CHResturantCategoriesListViewController:UITableViewDelegate,UITableViewDataSource
{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
            let vc = (storyboard?.instantiateViewController(withIdentifier: "CHCategoriesRestaurantViewController") as? CHCategoriesRestaurantViewController)!
            let obj = self.categories[indexPath.row]
            vc.selectedCategory = obj.name
